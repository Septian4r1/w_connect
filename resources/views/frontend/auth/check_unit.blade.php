...
<body>
    ...
    <div class="app">
        ...
        <div class="content">
            ...
            <form id="verifikasiCheckForm" method="POST" action="{{ route('forgotPassword.verifikasiCheckUnit') }}">
                @csrf

                <div class="form-group">
                    <label>NIK Kartu Keluarga</label>
                    <input type="text" name="no_kk" placeholder="Contoh: 2164********" required>
                </div>

                <div class="form-group">
                    <label>Block / No Rumah</label>
                    <input type="text" name="blok" placeholder="Contoh: A3/31" required>
                </div>

                <button class="btn-login" type="submit">Verifikasi Data</button>
            </form>
            <div class="footer">
    ...
    @if (session('error') || session('success'))
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                @if (session('error'))
                    showAlert('error', 'Gagal', @json(session('error')));
                @endif
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // =========================
            // 4. Cegah screenshot dengan blur saat tab tidak fokus
            // =========================
            ...
            // =========================
            // 6. Form verifikasi checkbox
            // =========================
            const verifikasiForm = document.getElementById('verifikasiCheckForm');
            const overlay = document.getElementById('loadingOverlay');

            if (verifikasiForm && overlay) {
                const button = verifikasiForm.querySelector('button[type="submit"]');

                verifikasiForm.addEventListener('submit', function() {
